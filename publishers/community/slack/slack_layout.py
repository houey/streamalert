...
'''
{
    ...
    "attachments": [
        {
            "fallback": "Rule triggered: multi_sudo_wget_curl_generic",
            "color": "#ff5a5f",
            "author_name": "javier_marcos",
            "author_link": "",
            "author_icon": "",
            "title": "multi_sudo_wget_curl_generic",
            "title_link": "https://git.musta.ch/csirt/streamalert/search?q=multi_sudo_wget_curl_generic+path%3A%2Frules",
            "text": "Identify use of wget/curl commands that utilize sudo.",
            "footer": "via Rules",
        ...
        },
        {
            "color": "#8ce071",
             "fields": [
				{
                    "title": "playbook",
                    "value": "(a) look at the fetched resource (malicious?) (b) look at the user (expected?)"
                },
                {
                    "title": "att&ck tactic",
                    "value": "Execution"
                ...
                {
                    "title": "att&ck url",
                    "value": "https://attack.mitre.org/wiki/Technique/T1059"
                }
            ]
        },
        {
		...
		{
			"color": "#7b0051",
			"author_name": "airbnb.s3.carbonblack.us-east-1",
			"title": "Record:",
			"text": "\n```\n{\n  'AlertCount': '1',\n  'AlertTimeFirst': '2019-02-17T06:47:33.475007Z',\n  'AlertTimeLast': '2019-02-17T06:47:33:470557Z',\n  'MergedBy': {\n    'cmdline': 'sudo -u rails RAILS_ENV=production sciprt/silhouette.rb /srv/silhouette.yml b2e7b434-749a-4e71-aef2-943d598aea35 run_requests_from_ruL 2 curl',\n```",
			"fields": [],
			"mrkdwn_in": ["text"]
		},
		{
			"color": "#7b0051",
			"text": "\n```\n    'cwd': '/mnt/titanic/monorail/monotail_6908847686533bf440c6a0a72ea071f152a19a3c9_distribution-ubuntu_node_version-v8-9-1',\n    'gid': '1088',\n    'name': 'sudo',\n    'parent': '32750',\n    'path': '/usr/bin/sudo',\n    'pid': '32753',\n```",
			"mrkdwn_in": ["text"]
		},
		{
			"color": "#7b0051",
			"text": "```\n    'system_time': '0'\n  },\n  'counter': '80',\n  'decorations': {\n    'envIdentifier': 'prod',\n    'roleIdentifier': 'silhouette-runner',\n  }\n}\n```",
			"fields": [
				{
					"title": "Alert ID",
					"value": "aha378-38acbae3-0830b04a-04b4084"
				}
			],
			"footer": "via <https://www.google.com|s3>",
			"footer_icon": "https://cdn-images-1.medium.com/max/1200/1*Bbdx_ZjoHiUfjRaYha8xkQ.png",
			"mrkdwn_in": ["text"]
		}
    ]
}
